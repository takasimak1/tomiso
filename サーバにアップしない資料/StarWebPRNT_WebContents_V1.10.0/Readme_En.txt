...
=======================
  ...
  [SDK]
   - createTextElement
       Added base text magnification function.
   - createBarcodeElement
       Added an option for width.
...
=============
  ...
  StarWebPRNT_WebContents_V1.10.0
  |
...
=================
  ...
  [Printer Model]
       ...
       mC-Label2        (Ethernet/Bluetooth/USB: Ver1.0 or later)  (*1)
